<header class="topbar">
        <nav class="navbar top-navbar navbar-expand-md navbar-light">
            ...
            color: #fff;">
                ...
                <!-- Logo text --><span>
                    <!-- dark Logo text -->
                <a class="sm-hidden text-white" href="{{url('/')}}/admin">ShiaMarriage Bureau</a>
                    <!-- Light Logo text -->
            ...
            <ul id="sidebarnav">
                ...
                <li> <a class="has-arrow waves-effect waves-dark" href="#" aria-expanded="false"><i class="mdi mdi-bullseye"></i><span class="hide-menu">Manage Users</span></a>
                    <ul aria-expanded="false" class="collapse">
                        ...
                        <!-- <li><a href="{{url('/admin/retailers')}}">All Retailers</a></li> -->
                    </ul>
                </li>
                <!-- <li> <a class="has-arrow waves-effect waves-dark" href="#" aria-expanded="false"><i class="mdi mdi-file"></i><span class="hide-menu">Manage Catalog</span></a>
                    <ul aria-expanded="false" class="collapse">
                        <li><a href="{{url('/admin/managecategory')}}">Main Category</a></li>
                         <li><a href="{{url('/admin/managesubcategory')}}">Sub Category</a></li>
                         <li><a href="{{url('/admin/manageattribute')}}">Attribute</a></li>
                         <li><a href="{{url('/admin/setattributes')}}">Set Attributes</a></li>
                ...
                <li> <a class="has-arrow waves-effect waves-dark" href="#" aria-expanded="false"><i class="mdi mdi-bullseye"></i><span class="hide-menu">Manage category</span></a>
                    <ul aria-expanded="false" class="collapse">
                    <li> <a class="waves-effect waves-dark" href="{{url('/admin/category')}}">
                        <i class="mdi mdi-pen"></i><span class="hide-menu">Add Category</span></a>

                </li>
                <li> <a class="waves-effect waves-dark" href="{{url('/admin/managecategory')}}">
                        <i class="mdi mdi-pen"></i><span class="hide-menu">Category List</span></a>

                </li>
                    </ul>
                </li>

                <li> <a class="has-arrow waves-effect waves-dark" href="#" aria-expanded="false"><i class="mdi mdi-bullseye"></i><span class="hide-menu">Manage Subcategory</span></a>
                    <ul aria-expanded="false" class="collapse">
                    <li> <a class="waves-effect waves-dark" href="{{url('/admin/subcategory')}}">
                        <i class="mdi mdi-pen"></i><span class="hide-menu">Add Subcategory</span></a>

                </li>
                <li> <a class="waves-effect waves-dark" href="{{url('/admin/managesubcategory')}}">
                        <i class="mdi mdi-pen"></i><span class="hide-menu">Subcategory List</span></a>
