  ...
  @section('content')
      ...
      <div class="row page-titles">
          <div class="col-md-5 align-self-center">
              <h3 class="text-themecolor">Shoppers</h3>
          </div>
...
<div class="row" style="margin-top:10px;">
                    ...
                    <div class="col-12" id="load" style="position: relative;">
                        <div class="card" >
                            <div class="card-body">
                                <h4 class="card-title">Shoppers List </h4>
                                          ...
                                          @foreach($users as $user)
                                            <tr>
                                              ...
                                              <td>{{$user->mobilenumber}}</td>
                                                  <td>
                                                  <!-- <a href="{{url('/admin/editsubcategory',$user->id)}}"><button type="button" class="btn waves-effect waves-light   btn-warning "><i class="fa fa-edit" rel="tooltip" title="Edit"></i></button></a> -->
        ...
        jQuery('.status-button').click(function(e){
            ...
            var token = $("meta[name='csrf-token']").attr("content");
             ...
             bootbox.confirm("Do you really want to change status?", function(getresult) {
               if(getresult){
              jQuery.ajax({
                url:"{{ url('/admin/shopperstatus')}}/"+id,
                method : 'post',
          ...
          jQuery('.del-button').click(function(e){
            ...
            var token = $("meta[name='csrf-token']").attr("content");
             ...
             bootbox.confirm("Do you really want to delete record?", function(getresult) {
               if(getresult){
              jQuery.ajax({
                url:"{{ url('/admin/deleteshopper')}}/"+id,
                method : 'post',
                data: { id: id,
                  "_token": token,
                 },
